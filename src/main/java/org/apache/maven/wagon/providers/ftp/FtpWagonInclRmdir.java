 ...
 */
public class FtpWagonInclRmdir
    extends StreamWagon
{
    ...
    {
        private FtpWagonInclRmdir wagon;

        public PrintCommandListener( FtpWagonInclRmdir wagon )
        {
            this.wagon = wagon;
        }
  ...
  public void put(File source, String resourceName) throws TransferFailedException, ResourceDoesNotExistException, AuthorizationException {
    try {
      ...
      throw new TransferFailedException("Can not remove basefolder of " + resourceName + ". Cause: " + e.getMessage());
    }
    super.put(source, resourceName);
  }

  private void ensureBaseFolderIsCleanedUp(String resourceName) throws IOException {
